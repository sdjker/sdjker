...
class Simulation:
    ...
    def __init__(self, n, radius=0.01, styles=None, dt=0.01):
        ...
        self.n = None
        self.init_particles(n, radius, styles, dt)

    def init_particles(self, n, radius, styles=None, dt=0.01):
    ...
    def handle_collisions(self):
        ...
        for i in range(self.n):
            gravity_velocities(self.particles[i], self.dt)
...
if __name__ == '__main__':
    ...
    sim = Simulation(nparticles, radii, styles, 0.0005)
